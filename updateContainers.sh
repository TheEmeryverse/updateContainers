...
docker stop prowlarr; docker stop overseerr; docker stop tautulli; sudo docker stop qbittorrent; sudo docker stop bazarr; sudo stop readarr; sudo docker stop plex; sudo docker stop sonarr; sudo docker stop radarra
